package com.weebly.leeboxuan.demonotification;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnNotify1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                PendingIntent pIntent = PendingIntent.getActivity(MainActivity.this, reqCode, intent, PendingIntent.FLAG_CANCEL_CURRENT);
